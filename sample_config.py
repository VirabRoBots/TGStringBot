...
class Config(object):
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "MaximXRoBot")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "MaximXRoBot")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/MaximXRoBot")
    ...
    APP_DESCRIPTION = os.environ.get("APP_DESCRIPTION", "Created By @MaximXRobot")
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "Made With ❤ By @MaximXRobot")
