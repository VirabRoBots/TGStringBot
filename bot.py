...
def start(update, context):
    ...
    update.message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('Dᴇᴠᴇʟᴏᴘᴇʀ', url='https://t.me/MaximXRobot'),
                    InlineKeyboardButton('Sᴏᴜᴄʀᴇ Cᴏᴅᴇ', url='https://github.com/AL3X-Github/TGStringBot')
              ],[
                    InlineKeyboardButton('Bᴏᴛs Lɪsᴛ', url='https://telegram.dog/MaximXBots'),
                    InlineKeyboardButton('Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ', url='https://telegram.dog/MaximXGroup'),
                    InlineKeyboardButton('Uᴘᴅᴀᴛᴇ Cʜᴀɴɴᴇʟ', url='https://telegram.dog/MaximXChannels')
              ],[
                    InlineKeyboardButton('Sᴜʙsᴄʀɪʙᴇ YᴏᴜTᴜʙᴇ Cʜᴀɴɴᴇʟ', url='https://youtube.com/channel/UC9o1hM49jVr2lgOinw0pAdw')
               ]
            ]
        )
    )
    ...
    if status_r:
        ...
        if status_t:
            ...
            aes_mesg_i.edit_text(
                ...
                [
                    InlineKeyboardButton('Dᴇᴠᴇʟᴏᴘᴇʀ', url='https://t.me/MaximXRobot'),
                    InlineKeyboardButton('Sᴏᴜʀᴄᴇ Cᴏᴅᴇ', url='https://github.com/AL3X-Github/TGStringBot')
              ],[
                    InlineKeyboardButton('Bᴏsᴛ Lɪsᴛ', url='https://telegram.dog/MaximXBots'),
                    InlineKeyboardButton('Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ', url='https://telegram.dog/MaximXGroup'),
                    InlineKeyboardButton('Uᴘᴅᴀᴛᴇ Cʜᴀɴɴᴇʟ', url='https://telegram.dog/MaximXChannels')
              ],[
                    InlineKeyboardButton('Sᴜʙsᴄʀɪʙᴇ YᴏᴜTᴜʙᴇ Cʜᴀɴɴᴇʟ', url='https://youtube.com/channel/UC9o1hM49jVr2lgOinw0pAdw')
            ...
            LOGGER.warning("Creating APP ID Caused Error404 %s", response_dv)
...
def error(update, context):
    ...
    LOGGER.warning("Update %s Caused Error404 %s", update, context.error)
